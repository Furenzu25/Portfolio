...
export const personalInfo = {
  ...
  /** Set when resume PDF is added to /public (e.g. resume.pdf) */
...
export const summary = {
  short:
    "Full Stack Software Engineer with an emphasis on practical application and a detail-oriented approach.",
...
export const projects: Project[] = [
  {
    ...
    image: "/Screenshot%202026-04-29%20071707.png",
  ...
  },
  {
    ...
    tags: ["Full-Stack", "Event Management", "Submissions", "Google OAuth", "TypeScript", "ADDU"],
...
export const allSkillsFlat = [...new Set(skillCategories.flatMap((cat) => cat.skills))];
